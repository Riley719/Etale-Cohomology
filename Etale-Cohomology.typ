...
この射の条件はlocalである。詳しくは@SPAut18 の#link("https://stacks.math.columbia.edu/tag/00EP")[00EP]を参照されたい。
...
#statementsp(
  ...
  $f in k[x_1, dots, x_n]$を代数的閉体$k$上の既約多項式とする。多様体$f(x) = 0$上の点を$P$とする。ある偏導関数$(partial f) / (partial x_i)$が$P$において零でないとき，点$P$は非特異点であるという。$A=k[x_1,dots,x_n]\/(f)$とおき，$frak(m)$を点$P$に対応する$A$の極大イデアルとする。このとき，次を示せ。
  #align(center)[
